...
export default function SendQRBulk({ isOpen, onClose, eventId, offline, sentCount }) {
            ...
            <div className="bg-white rounded-lg shadow-lg w-full max-w-md overflow-hidden">
                ...
                <div className="p-6 space-y-6">
                    <p className="text-sm font-['Plus_Jakarta_Sans'] leading-normal font-normal">
                        Kirim email QR ke <strong>{targetCount} peserta offline</strong> di event ini?
                        <br /><br />
                        Secara default, email hanya akan dikirim ke peserta yang belum menerima QR.
                        <br />
                    ...
                    <form onSubmit={submit}>
                        {sentCount > 0 && (
                            <div className="mb-4 flex items-center gap-2">
                                ...
                                />
                                <label htmlFor="resend_all_qr" className="text-sm font-['Plus_Jakarta_Sans'] text-default cursor-pointer">
