...
export default function AdminLayout({ children, title }) {
    ...
    return (
        <div className="min-h-screen bg-white flex">
            {/* SIDEBAR */}
            <aside
                className={`fixed left-0 top-0 z-30 bg-white border-r border-slate-700/30 transition-all duration-300 ease-in-out ${
            ...
            {/* MAIN CONTENT AREA */}
            <div
                className={`flex-1 flex flex-col overflow-hidden ${isSidebarOpen ? "ml-81.25" : "ml-23"}`}
            >
